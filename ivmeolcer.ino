...
// https://github.com/akafugu/MMA845XQ
// jiroskop
...
void loop() {
  ...
  Serial.println("x: " + String(accel.getX()) + " y: " + String(accel.getY()) + " z:" + String(accel.getY()));
  /*Serial.println("rho: " + String(accel.getX()) + " phi: " + String(accel.getY()) + " theta:" + String(accel.getY()));*/
  Serial.println("");
